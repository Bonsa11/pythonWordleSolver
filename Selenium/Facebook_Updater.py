...
# look up selenium setup tutorial to find this5

fb_login = 'alexbodza@gmail.com'
fb_pass = 'Poppy2020'
...
search_term = 'dentist uk'
search_term = search_term.split(' ')
search_term = str('+'.join(search_term))

link = 'https://www.google.com/search?q='+ search_term +'&hl=en&sxsrf=ALeKk01Ds170v8PIq2dFVvkWfoyllX5y7g:1601197315311&source=lnms&tbm=nws&sa=X&ved=2ahUKEwivysbp_IjsAhVEiFwKHQZLCTMQ_AUoAnoECAwQBA&biw=1745&bih=888'
...
body = search.find_element_by_xpath('//*[@id="rso"]/div[1]/g-card/div/div/div[2]/a/div/div[2]/div[3]/div[1]').text
...
findby_xpath_click('//*[@id="page_browser_your_pages"]/div/div[2]/div[1]/div[1]/div/div[1]/a') # click on page
time.sleep(5)
